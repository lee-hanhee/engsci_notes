...
\section{DT Properties of LTI systems (Ch. 2.3)} % MIDTERM CUT OFF
...
\input{Lectures/10_Periodic_signals_and_Fourier_series_DT.tex}
\newpage
...
\input{Lectures/12_Response_of_LTI_systems_to_periodic_signals.tex}
\newpage
